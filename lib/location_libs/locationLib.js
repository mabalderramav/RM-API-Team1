 ...
 * @param {object} locationJson, contains a json file with the location attributes.
 ...
 * @param {object} locationJson, contains a json file with the location attributes that will be updated.
 * @param {function}callback, contains the error and the response.
 */
