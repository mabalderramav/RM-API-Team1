 ...
 *
 * @param {object} meetingJson, contains a json file with the meeting attributes.
 ...
 * @param {object}meetingJson, contains a json file with the meeting attributes that will be updated.
 * @param{function} callback, contains the error and the response.
 */
